...
GOLD_LABELS_TEST_PATH = "test-input/test-input/tweet-vclaim-pairs.qrels"
# TWEETS_TEST_PATH = "test-input/2020_2_test_input/tweets.queries.tsv"
# GOLD_LABELS_TEST_PATH = "test-input/2020_2_test_input/tweet-vclaim-pairs.qrels"
